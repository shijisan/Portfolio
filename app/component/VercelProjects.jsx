		...
		const fetchProjects = async () => {
			try {
				...
				if (Array.isArray(data)) {
					setProjects(data);
					setVisibleProjects([data[0]]); // Show first project initially
				} else {
			...
			<div className="flex flex-col items-center w-[80vw] h-full">
				...
				{visibleProjects.map((project, index) => (
                  ...
                  ${index % 2 === 0
					...
					>
						{/* Use Cloudinary URL as the image source */}
						<img
							src={project.screenshotUrl}  // Use Cloudinary URL for the project image
